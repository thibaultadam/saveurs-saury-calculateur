[calculateur-oakaddins](../README.md) / [Exports](../modules.md) / [OakAddins/Code/ChoicesManager/ChoiceParamParser](../modules/oakaddins_code_choicesmanager_choiceparamparser.md) / ChoiceParamParser
